...
public class IntCalcMain {
    ...
    public static void main(String[] args) {
        ...
        BigDecimal principle = new BigDecimal(input.nextLine()).setScale(2);
        System.out.print("Enter annual interest rate in % form: ");
        BigDecimal interest = new BigDecimal(input.nextLine()).setScale(2);
        ...
        for (int i = 0; i < acc.getTerm(); i++) {
            ...
            System.out.printf("Year Start = $%.2f", acc.getInvestment().setScale(2));
            System.out.printf("\nAnnual Interest Earned: $%.2f", acc.calcYearlyIntr());
            System.out.printf("\nApproximate Interest Earned per quarter: $%.2f", acc.calcQuarterlyIntr().setScale(2));
            System.out.printf("\nApproximate Interest Earned per month: $%.2f", acc.calcMonthlyIntr().setScale(2));
            System.out.printf("\nApproximate Interest Earned per daily: $%.5f", acc.calcDailyIntr().setScale(2));
